      ...
      >
        <Drawer.Portal>
          ...
          >
            ...
            <div className="bg-background h-full w-full grow flex flex-col sm:rounded-2xl shadow-xl border-l sm:border border-border transition-colors duration-300 overflow-hidden">
              {/* Header */}
              <div
                data-system-bar
